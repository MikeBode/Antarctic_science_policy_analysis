...
figure(2), clf, hold on; FS = 16; CL = get(gca,'colororder');
...
for i = 1:46
    b = bar(i,ATS_strength_climate_contributions(I(i)),0.8);
    set(b,'edgecolor','none','facealpha',0.5,'facecolor',0.5.*ones(1,3))
    if i == 1 | i == 2 | i == 9 | i == 18 | i == 25 | i == 34 | i == 40
        set(b,'edgecolor','none','facealpha',0.5,'facecolor',CL(4,:))
    end
